...
const Home = ()=> {
    return(
        ...
        <img className="pics" src='/linkedin.jpg' alt="image" />LinkedIn
        </a>
        <a href="https://github.com/MahanteshMuttagi" target="_blank" rel="noreferrer">
        <img className="pics" src='/github.jpg' alt="image" />GitHub
        </a>
        <a href="https://www.hackerrank.com/profile/mahanteshmuttag1" target="_blank" rel="noreferrer">
        <img className="pics" src='/hackerrank.jpg' alt="image" />HackerRank
        </a>
        <a href="https://www.facebook.com/" target="_blank" rel="noreferrer">
        <img className="pics" src='/facebook.jpg' alt="image" />FaceBook
        </a>
